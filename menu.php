...
<a class="list-group-item" id="menusolicitudes" href="#"><i class="fa fa-file-o fa-2x"></i> Solicitudes</a>
<a class="list-group-item submenu" id="menuvacaciones" href="<?=URLBASE;?>contenido/vacaciones.php"><i class="fa fa-sun-o fa-2x"></i> Vacaciones</a>
